        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center mb-4">
              <Crown className="h-12 w-12 text-renaissance-gold mr-3" />
          ...
          <div className="mb-12 max-w-2xl mx-auto">
            <p className="text-xl font-crimson text-foreground/80 leading-relaxed mb-6">
              Discover the Renaissance spirit within you through an elegant personality assessment. 
            ...
            <p className="text-lg font-crimson text-muted-foreground">
              This prototype focuses on matching you with <span className="font-semibold text-renaissance-burgundy">Lorenzo "The Magnificent" de' Medici</span>, 
              the legendary patron of arts and Renaissance leader.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-3xl mx-auto">
            <div className="text-center">
              <Palette className="h-8 w-8 text-renaissance-gold mx-auto mb-3" />
            ...
            <div className="text-center">
              <Heart className="h-8 w-8 text-renaissance-gold mx-auto mb-3" />
            ...
            <div className="text-center">
              <Crown className="h-8 w-8 text-renaissance-gold mx-auto mb-3" />
              <h3 className="font-playfair font-semibold text-lg mb-2">Historical Match</h3>
              <p className="font-crimson text-sm text-muted-foreground">
                Connect with Renaissance history and wisdom
              </p>
            </div>
          </div>
